        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('account_subcategory/add') ?>" type="button" class="btn btn-primary btn-icon-text">
                    ...
                    <a href="<?= base_url('account_subcategory/copy') ?>" type="button" class="btn btn-info btn-icon-text">
...
<script>
    $(document).ready(function() {
        ...
        grid_brand = table.DataTable({
            ...
            ajax: {
                type: "GET",
                url: '<?= base_url() ?>account_subcategory/load',
                data: function(d) {
                    no = 0;
                },
                dataSrc: "",
            ...
            columns: [{
                ...
                {
                    render: function(data, type, full, meta) {
                        // return `<a href="${siteUrl}account_subcategory/edit/${full.uuid}" class="btn btn-info btn-sm btn-icon" type="button"><i class="ti-receipt"></i></a>
                        ...
                        return `<div><a href="${siteUrl}account_subcategory/edit/${full.uuid}" class="btn btn-info" type="button"><i class="ti-receipt"></i></a>
    ...
    function hapus(uuid) {
        cuteAlert({
            ...
            if (e === "confirm") {
                $.ajax({
                    url: siteUrl + 'account_subcategory/hapus',
                    type: 'POST',
                    data: {
                        uuid
                    },
    ...
    $('#unduhTemplate').on('click', function() {
        window.location.href = siteUrl + 'account_subcategory/unduhTemplate'
    })
    ...
    $('#formUpload').on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: siteUrl + 'account_subcategory/import',
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
