...
class Account_formulir extends MY_Controller
{
    ...
    public function index()
    {
        $data = [
            ...
            'sidebar' => 'account_formulir',
            'heading' => 'PRODUCT/SERVICE FORMULATION'
        ];
        ...
        $data['forms'] = $finals;
        $this->admin_template->view('account_formulir/vw_account_formulir', $data);
    }
    ...
    public function add()
    {
        ...
        $this->admin_template->view('account_formulir/vw_add', $data);
    }
    ...
    public function edit($uuid)
    {
        ...
        $this->admin_template->view('account_formulir/vw_edit', $data);
    }
    ...
    public function copy()
    {
        ...
        $data['sbu'] = $this->mo_sbu->getListSbu($this->wheres_listsbu);
        $this->admin_template->view('account_formulir/vw_copy', $data);
    }
