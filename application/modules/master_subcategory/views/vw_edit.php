                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="form_edit">
                        ...
                        <div class="form-group">
                            <label for="name_subcategory_monitoring">Nama Sub Kategori<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name_subcategory_monitoring" name="name_subcategory_monitoring" placeholder="Nama sub kategori" required value="<?= $subcategory['name_subcategory_monitoring'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="<?= base_url('master_subcategory') ?>" class="btn btn-light">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    $('#form_edit').on('submit', function(e) {
        ...
        e.preventDefault()
        $.ajax({
            url: siteUrl + "master_subcategory/submitEdit",
            method: "POST",
            dataType: "JSON",
            processData: false,
            contentType: false,
