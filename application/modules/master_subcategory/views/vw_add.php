                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="form_add">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name_subcategory_monitoring" name="name_subcategory_monitoring" placeholder="Nama sub kategori" required>
                        </div>
                        <div class="form-group">
...
<script>
    $('#form_add').on('submit', function(e) {
        ...
        e.preventDefault()
        $.ajax({
            url: siteUrl + "master_subcategory/submitAdd",
            method: "POST",
            dataType: "JSON",
            processData: false,
            contentType: false,
