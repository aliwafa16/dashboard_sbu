            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="form_add">
                        ...
                        <div class="form-group">
                            <label for="subcategory_account_id">Sub Kategori<span class="text-danger">*</span></label>
                            <select class="form-control js-example-basic-single" id="subcategory_account_id" name="subcategory_account_id" required>
                                <option value="">--Pilih--</option>
...
<script>
    ...
    $('#form_add').on('submit', function(e) {
        ...
        e.preventDefault()
        $.ajax({
            url: siteUrl + "account_item/submitAdd",
            method: "POST",
            dataType: "JSON",
            processData: false,
            contentType: false,
